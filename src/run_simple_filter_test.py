#!/usr/bin/env python3
"""
Simplified script to run filtering on existing Django PR data.
This preserves your existing directory structure and only creates
the necessary output directory.
"""
