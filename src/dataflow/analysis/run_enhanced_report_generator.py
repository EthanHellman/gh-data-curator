...
#         from enhanced_report_generator import EnhancedReportGenerator
#     except ImportError:
#         logger.error("Could not import EnhancedReportGenerator. Make sure the file is in the current directory.")
#         sys.exit(1)
...
def main():
    ...
    try:
        from core_generator import EnhancedReportGenerator
    except ImportError:
        ...
        try:
            ...
            logger.error("Could not import EnhancedReportGenerator. Make sure all required files are in the current directory.")
            sys.exit(1)
